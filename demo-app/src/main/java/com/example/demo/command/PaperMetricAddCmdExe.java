...
import com.example.demo.domain.metrics.techinfluence.PaperMetric;
import com.example.demo.domain.metrics.techinfluence.PaperMetricItem;
import com.example.demo.domain.user.UserProfile;
import com.example.demo.dto.PaperMetricAddCmd;
