...
import com.example.demo.domain.metrics.techinfluence.SharingMetric;
import com.example.demo.domain.metrics.techinfluence.SharingMetricItem;
import com.example.demo.domain.metrics.techinfluence.SharingScope;
import com.example.demo.domain.user.UserProfile;
import com.example.demo.dto.SharingMetricAddCmd;
